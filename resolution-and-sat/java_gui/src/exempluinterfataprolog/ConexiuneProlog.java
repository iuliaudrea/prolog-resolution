...
public class ConexiuneProlog {
    final String caleExecutabilSicstus="/usr/local/bin/swipl";
    ...
    public ConexiuneProlog(int _port, Fereastra _fereastra) throws IOException, InterruptedException{
        ...
        /*
        String comanda = "osascript -e 'tell application \"Terminal\" to do script \"cd /Users/iulik_pisik/Downloads/interfata && swipl -g " 
                 + scop + " -s " + nume_fisier + " -- " + port + "\"'";
        procesSicstus = rtime.exec(new String[] { "bash", "-c", comanda });
        */
